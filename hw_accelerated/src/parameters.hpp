...
constexpr unsigned int STAMP_BITS = ceillog2(UNIQUE_STAMPS + RESERVED_STAMP_IDS);
...
#define USE_VSIDS
constexpr unsigned int VSIDS_ACTIVITY_PARTITION_FACTOR = 32;
constexpr unsigned int VSIDS_COMPARE_STAGES = ceillog2(VSIDS_ACTIVITY_PARTITION_FACTOR) + 1;
